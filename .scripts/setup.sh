...
# Install packages
sudo apt-get update
sudo apt-get -y install apt-file curl default-jre-headless devscripts icedtea-netx jq language-pack-en nfs-common openssh-server ssh-askpass-gnome tree virt-manager virt-what zip zsh
